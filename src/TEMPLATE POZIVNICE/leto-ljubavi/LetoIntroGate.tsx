...
/** Horizontal sway in px (CSS centers the dancer — no vw motion values) */
const SWAY_PX = [-18, 18] as const;
...
function LetoIntroGate({ onOpen, onFinished }: LetoIntroGateProps) {
  ...
  const [zoomOrigin, setZoomOrigin] = useState("50% 26%");
  ...
  useEffect(() => {
    ...
    const controls = animate(swayX, [...SWAY_PX], {
  ...
  const open = () => {
    ...
    // Settle sway to center before / while zooming into heads
  ...
  return (
    ...
    >
      <div className="ll-gate__stage">
        ...
        {/* CSS centers this anchor; FM only sways a few px — avoids mobile vw/translate bugs */}
